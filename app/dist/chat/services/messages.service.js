...
let MessagesService = class MessagesService {
    ...
    async saveMessage(messageData, author, channel) {
        const newMessage = await this.messagesRepository.create(Object.assign(Object.assign({}, messageData), { author, channel }));
